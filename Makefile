#	makefile for STG68K_CNV.X
PROGNAME	:= STG68K_CNV.X
SRCDIR		:= src
INCDIR		:= inc
LIBDIR		:= lib
OBJDIR		:= build
...
LDFLAGS 	= -s
LIBS		= libc.a libgnu.a libdos.a libiocs.a lib/APICGLIB.a lib/ZMUSIC.L lib/JOYLIB3.L lib/XSP2lib.o Lib/PCM8Afnc.o
